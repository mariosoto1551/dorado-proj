...
/**
 * Modelos tenant-scoped de session (ADR-00 §2): los tres llevan organizacionId
 ...
 * organización. `UltimoTickProcesado` NO va acá: es operacional del scheduler
 * (corre sin contexto de tenant, igual que las rutas /internal/*).
 */
const MODELOS_TENANT = {
  ConfiguracionSesion: { conGrupoId: true },
  Seccion: { conGrupoId: true },
  Sesion: { conGrupoId: true },
};
