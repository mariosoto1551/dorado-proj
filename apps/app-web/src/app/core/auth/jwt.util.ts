 ...
 * firma no se puede (ni se debe) verificar: el token solo se usa para leer
 * rol/grupos y decidir UI. La autoridad real es el Gateway, que sí valida
 * RS256 en cada request (fase-03).
 */
