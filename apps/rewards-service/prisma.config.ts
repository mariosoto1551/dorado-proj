...
//
// Correr los comandos de Prisma con cwd en apps/rewards-service, ej.:
//   pnpm nx run rewards-service:prisma-migrate
//
// Sin bloque `migrations.seed`: las Recompensas las crean los tutores por API.
