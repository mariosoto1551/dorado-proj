...
/**
 * Publicador de eventos de dominio de rewards-service. Envuelve SIEMPRE el
 ...
 *
 * Todos los eventos de esta fase nacen de un request HTTP (canjes), así que
 * el correlationId sale del scope abierto por el middleware de correlación.
 */
@Injectable()
export class EventosPublisherService {
  private static readonly PRODUCTOR = 'rewards-service';

  /** Prefijo de routing key (`<servicio>.accion_administrativa`, ADR-00 §5). */
  private static readonly SERVICIO = 'rewards';
