 ...
 *
 * Usos en esta fase: usuarios ACTIVO del grupo para las evaluaciones de zona
 * (consumidores de SesionCerrada/SeccionEntroEvaluacion) y para el listado de
 * puntajes; validación de pertenencia de grupo/usuario en los endpoints
 * (regla 3 de CLAUDE.md — el cliente nunca decide el tenant).
 *
 * Fail-closed (503 en endpoints, error en consumidores → retry/DLQ) si
 * identity no responde: son validaciones de aislamiento y evaluaciones de
 * negocio, nunca se adivina.
 */
@Injectable()
