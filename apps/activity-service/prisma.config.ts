...
//
// Correr los comandos de Prisma con cwd en apps/activity-service, ej.:
//   pnpm nx run activity-service:prisma-migrate
//
// Sin bloque `migrations.seed`: activity no tiene datos de catálogo propios
// (los Planes viven en billing; las Actividades/Conductas las crean los
// tutores por API).
